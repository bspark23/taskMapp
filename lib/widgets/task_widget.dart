    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(color: const Color.fromARGB(255, 64, 15, 197)),
          color: const Color.fromARGB(255, 122, 107, 187),
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                Flexible(
                  child: Attendees(
                    border: Border.all(color: const Color.fromARGB(255, 96, 120, 228), width: 3),
                    backgroudColor: const Color.fromARGB(255, 24, 148, 250),
                  ),
                ),
    ...
    return InkWell(
      ...
      child: Container(
        decoration: const BoxDecoration(
          ...
          color: Color.fromARGB(255, 167, 11, 11),
        ),
        height: 50,
        width: 50,
