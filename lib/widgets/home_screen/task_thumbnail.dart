  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color.fromARGB(255, 7, 43, 204),
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          FittedBox(
            fit: BoxFit.fitWidth,
            child: Attendees(
              border: Border.all(color: const Color.fromARGB(255, 47, 24, 250), width: 3),
              backgroudColor: const Color.fromARGB(255, 10, 40, 216),
            ),
          ),
          const Spacer(),
          Align(
